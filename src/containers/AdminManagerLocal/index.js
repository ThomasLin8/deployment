        ...
        <Col xl={7} lg={7} md={7} sm={7} xs={24}>
          <div className="profile">
            ...
            <div className="profileInfo">
              <h1> <font color='gray'>Marion Fleming</font></h1>
              <p> <font color='gray'>5261 Adelaide Ave</font></p>
              <p className="profileAbout">
              <font color='gray'> 这里是一些个人简介，Ba la Ba la Ba la Ba la Ba la Ba la Ba la Ba la Ba la Ba la Ba la Ba la...</font>
                 </p>
            </div>
          </div>
        </Col>
